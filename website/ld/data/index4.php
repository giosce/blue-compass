...
/*
$properties_a = parse_ini_file("../../properties.ini");
...
"select ld, a.year, office, sum(dem_votes) as dem_votes, sum(rep_votes) as rep_votes, 
...
$sql5 = "select county, town, muni_code, cd from municipal_list_new where ld=".$ld_id." order by 1, 2";
...
$sql_repr = "select * from representatives where ld='".$ld_id."'";
$representatives_query = mysqli_query($conn, $sql_repr);

if($debug=="y") { // debug
	echo $sql5."<br>";
	echo $sql_election_results."<br>";
	echo $results_by_county_sql."<br>";
	echo $sql_repr."<br>";
}
...
while($row5 = mysqli_fetch_array($query5)) {
	...
	echo "<a href='muni.php?ld=".$ld_id."&muni_id=".$row5["muni_code"]."'>".$row5["town"]."</a> ";
	array_push($cds, $row5["cd"]);
}
$cds2 = array_values(array_unique($cds));
//print_r($cds2);
echo "<br><br>";
echo "The Legislative District <b>LD".$ld_id."</b> is part of <b>";
