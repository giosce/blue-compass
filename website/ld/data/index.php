...
while($row5 = mysqli_fetch_array($query5)) {
	...
	echo "<a href='../../muni/?muni_id=".$row5["muni_code"]."'>".$row5["town"]."</a> ";
...
for($x=0; $x < count($cds2); $x++) {
	echo "<a href='../../cd/data?cd=".$cds2[$x]."'>".$cds2[$x]."</a> ";
}
...
echo "<center><H2 title='See your candidates'><a href='../../2021/candidates.php?district=LD".$ld_id."'>Election Coming Up!!</a></H2></center>";
