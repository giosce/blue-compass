...
$sql5 = "select county, town, muni_id, ld from municipal_list where cd=".$cd_id."  and county='".$county."' order by 1, 2";
...
"select a.muni_code, b.municipality, party, a.citizens_18_plus, 
...
and status='Active' and a.county='".$county."'
