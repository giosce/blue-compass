...
voter you may know someone in the committee. If you don’t know your “precinct” you can find it out <a href="../myinfo"><b>here</b></a>.
<br>
...
<td>
<select name="town" id="select_town" style="width: 160px;" onchange="this.form.submit();">
<option value=''></option>
<?php
...
if(!empty($committee)) {
	...
	echo "<td>Next Election: ".$committee["next_election"]."</td>"; 
}
?>
</table>
<br>
...
tabdropdown.init("bluecompasstab", 3);
</script>
